...
export const Hero = () => {
  return (
    <div className="relative flex flex-col-reverse py-16 lg:pt-0 lg:flex-col lg:pb-0">
      ...
      <div className="relative flex flex-col items-start w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:max-w-screen-xl z-0">
        <div className="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
          ...
          <p className="pr-5 mb-5 text-base text-gray-700 md:text-lg">
            IdeaLoader helps you start with a fresh clean concept. We get the
