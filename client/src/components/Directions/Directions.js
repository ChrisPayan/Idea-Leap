      ...
      <div className="grid max-w-2xl mx-auto">
          ...
          <div className="flex flex-col pb-6 sm:items-center sm:flex-row sm:pb-0">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm text-gray-400">
                Click on the start a new idea button and we will give you a pool of random words to get 
                thing started. 
              </p>
            </div>
          </div>
        ...
        <div className="flex">
          ...
          <div className="flex flex-col pb-6 sm:items-center sm:flex-row sm:pb-0">
            ...
            <div>
              <p className="text-gray-100 text-xl font-semibold sm:text-base">Get Things Started.</p>
              <p className="text-sm text-gray-400">
                Pick the words that pop out to you. These words will be grouped together once you have finished.
              </p>
            </div>
          </div>
        </div>
        <div className="flex">
          ...
          <div className="flex flex-col pb-6 sm:items-center sm:flex-row sm:pb-0">
            ...
            <div>
              <p className="text-gray-100 text-xl font-semibold sm:text-base">Creat Your Ideas.</p>
              <p className="text-sm text-gray-400">
                Your pool of words will populate in the idea map. Sort and align items in a fashion that makes sense to you. Feel free to add your own words or generate more!
              </p>
            </div>
          </div>
        </div>
